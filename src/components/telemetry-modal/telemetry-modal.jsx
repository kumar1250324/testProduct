...
const messages = defineMessages({
    ...
    bodyText1: {
        defaultMessage: 'The Scratch Team myaimate is always looking to better understand how Scratch is used around the ' +
    ...
    bodyText2: {
        defaultMessage: 'The information mk we collect includes language selection, blocks usage, and some events like ' +
